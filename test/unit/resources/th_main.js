...
exports.thunkConsoleForNonTestUniverse = function() {
  ...
  window.console = {
    ...
    log:   wrapConsole('log', (msg) => logic(scope, 'log', { msg: msg })),
    error: wrapConsole('error', (msg) => logic(scope, 'error', { msg: msg })),
    info:  wrapConsole('info', (msg) => logic(scope, 'info', { msg: msg })),
    warn:  wrapConsole('warn', (msg) => logic(scope, 'warn', { msg: msg })),
    trace: function() {
...
var TestUniverseMixins = {
  ...
  do_cronsync_trigger: function(opts) {
    ...
    this.T.action(this, 'trigger cronsync', this.eCronSync, function() {
      ...
      this.eCronSync.expect('alarmFired');
