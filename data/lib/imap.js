...
ImapConnection.prototype.connect = function(loginCb) {
   ...
   * @param data {Buffer}
   *   The data to append.
   * @param prescanned {Boolean|Number}
   *   true if all the data being appended does not need to be CRLF scanned.
   *   The amount of data that has been scanned if some has been scanned.
   *   Pass false/zero otherwise.
   */
  function bufferStateData(data) {
console.warn('buffering', data.toString('ascii'));
