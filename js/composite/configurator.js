...
return function(userDetails, domainInfo) {
  ...
  _defineImapAccount: function(universe, engine, userDetails, credentials,
    ...
    var accountDef = {
      ...
      engine,
      engineData: {
        capability: imapProtoConn.capability
      },
      receiveType: 'imap',
      sendType: 'smtp',
    ...
    return this._saveAccount(universe, accountDef, imapProtoConn);
  },
  ...
  _definePop3Account: function(universe, engine, userDetails, credentials,
    ...
    return this._saveAccount(universe, accountDef, pop3ProtoConn);
  },
   ...
   * then load it.
   */
  _saveAccount: function(universe, accountDef, protoConn) {
